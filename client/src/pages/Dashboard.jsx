...
const KPI = [
  { key: 'activeVehicles',      label: 'Active Vehicles',    icon: '🚛', color: '#4f8ef7' },
  ...
  { key: 'driversOnDuty',       label: 'Drivers On Duty',    icon: '👤', color: '#22c55e' },
];
...
export default function Dashboard() {
  ...
  return (
    <div>
      ...
      {loading ? (
        <div className="loader"><div className="spinner"></div> Loading dashboard…</div>
      ) : (
      ...
      <div style={{ marginTop: 12 }}>
        <div className="table-wrap">
          <div style={{ padding: '16px 20px', borderBottom: '1px solid var(--border)', fontSize: 13, color: 'var(--text-muted)' }}>
            ℹ️ Use the sidebar to navigate to Vehicles, Drivers, and Trips management.
          </div>
        </div>
      </div>
    </div>
