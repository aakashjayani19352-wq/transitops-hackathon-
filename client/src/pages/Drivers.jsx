          ...
          <form onSubmit={handleSubmit}>
            <div className="form-grid">
              ...
              <div className="form-group">
                ...
                <input name="licenseNumber" value={form.licenseNumber} onChange={handleChange} placeholder="e.g. KA0119801234567" required />
              </div>
              <div className="form-group">
                <label>License Category</label>
                <select name="licenseCategory" value={form.licenseCategory} onChange={handleChange} required>
              ...
              <div className="form-group">
                ...
                <input name="licenseExpiryDate" type="date" value={form.licenseExpiryDate} onChange={handleChange} required />
              </div>
              <div className="form-group">
                <label>Contact Number</label>
                <input name="contactNumber" value={form.contactNumber} onChange={handleChange} placeholder="e.g. 9876543210" required />
              </div>
              <div className="form-group">
                <label>Safety Score (0–100)</label>
                <input name="safetyScore" type="number" min="0" max="100" value={form.safetyScore} onChange={handleChange} placeholder="e.g. 85" />
              </div>
              <div className="form-group">
                <label>Status</label>
            ...
            <tbody>
              {drivers.map((d, i) => (
                <tr key={d._id || i}>
                  ...
                  <td>{d.licenseExpiryDate ? new Date(d.licenseExpiryDate).toLocaleDateString() : '—'}</td>
